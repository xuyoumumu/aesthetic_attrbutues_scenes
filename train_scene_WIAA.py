...
from model.resnet_multask_WIAA import resnet_gap_features
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file_path", default="F:/IQA/deep-photo-aesthetics-master/WIAA_scene_config.json")
